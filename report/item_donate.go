...
func ItemDonateReport(aggParams DonateItemParams, itemDonateColl *mongo.Collection) ([]interface{}, error) {
	...
	findResult, err := itemDonateColl.Aggregate(pipelineAgg)
	if err != nil {
...
func CreateReport(reportGen DonateReport, reportColl *mongo.Collection) (*mgo.InsertOneResult, error) {
